...
class MaskRCNN(object):
    ...
    def __init__(self, mode, config, model_dir, learning_rate, learning_momentum):
        """
        ...
        # self.lm = self.config.LEARNING_MOMENTUM

        self.lr = learning_rate
        self.lm = learning_momentum
    ...
    def compile(self):
        ...
        """
        # Optimizer object
        optimizer = keras.optimizers.SGD(self.lr_scheduler(0), momentum = self.lm,
        nesterov = True,
    ...
    def train(self, train_dataset, val_dataset, epochs,layers,models,
                augmentation=False, no_augmentation_sources=None,csv_logger_filename=None,
                reduce_lr_factor=None, reduce_lr_patience=None, reduce_lr_min_lr=None,
        ...
        csv_log = keras.callbacks.CSVLogger(csv_logger_filename, separator=',',append=True)
        ...
        callb = [
            ModelCheckpoint(self.checkpoint_path,save_weights_only=True,save_best_only = False, monitor = "val_loss", verbose = 1), 
            lr_rate , csv_log, reduce_lr, early_stop,
